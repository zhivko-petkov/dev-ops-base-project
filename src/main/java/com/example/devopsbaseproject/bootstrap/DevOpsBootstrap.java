package com.example.devopsbaseproject.bootstrap;
...
import com.example.devopsbaseproject.repositories.AuthorRepository;
import com.example.devopsbaseproject.repositories.ProductCategoryRepository;
...
public class DevOpsBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DevOpsBootstrap(AuthorRepository authorRepository,
